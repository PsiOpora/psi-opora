 ...
 */
export type WhatsappPersonalAccountStatus = "connected" | "limited" | "error";
...
/** Синхронизирует сохранённый аккаунт с живым состоянием WAHA. */
export async function setWhatsappPersonalAccountStateBySession(
	sessionName: string,
	status: WhatsappPersonalAccountStatus,
