...
export interface OutboundMessage {
	...
	jobId: string;
	/** По умолчанию send. delete отзывает ранее отправленное сообщение по
	 * externalId для обеих сторон. */
	action?: "send" | "delete";
...
export interface SendResult {
	...
	/** ID созданного сообщения Telegram, необходимый для последующего отзыва. */
	externalId?: string;
}
