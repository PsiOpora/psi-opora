...
export const SCENARIO_TEXT_DEFS = [
  ...
  // ── 2b. Согласие на рекламную рассылку: отдельный явный шаг ────────────────
  {
    ...
    hint: "Показывается отдельным шагом сразу после согласия на обработку ПДн — до продолжения диалога в любом из флоу. Отдельное явное согласие, не объединяется с другими документами.",
    group: "2b. Согласие на рекламную рассылку",
    multiline: true,
    defaultValue:
