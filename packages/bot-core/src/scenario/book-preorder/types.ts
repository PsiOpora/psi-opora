 ...
 * Независим от основного движка (../engine.ts): свои шаги, реальная оплата
 * и многодневная рассылка — общего с флоу консультации/гайда почти нет,
 * см. пояснение в scenario/book-preorder/engine.ts.
 */
