  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          После того как клиент оставил email в ветке гайда, PDF уходит
          вложением на почту (нужен RESEND_API_KEY) и, в MAX, дополнительно
          документом в чат — в Telegram отправляется только по email. Хранится
          в S3 (используются настройки из раздела «Бэкап CRM»). До 10 МБ.
        </CardDescription>
      </CardHeader>
